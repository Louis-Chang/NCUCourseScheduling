...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col">
                <input type="text" class="form-control" placeholder="請輸入查詢關鍵字" aria-label="請輸入查詢關鍵字" id="keyword" disabled>
            </div>
            <div class="col-auto">
                <button type="submit" value="" class="btn btn-primary mb-3" onclick="location.href='course.php'">顯示全部</button>
            </div>
        </div><br>
        ...
        <table class="table table-hover" id="table">
            ...
            <tbody id="tbody">
                <?php
                    ...
                    if($s = mysqli_query($conn, "SELECT * FROM course WHERE teacher = '$teacher' ORDER BY no ASC")) {
                        while($r = mysqli_fetch_array($s)) {
                            echo "<form action = select.php method=post>";
                            echo "<tr><td>".$r['no']."</td><td>".$r['id']."</td><td>".$r['name']."</td><td>".$r['teacher']."</td><td>".$r['type']."</td><td>".$r['credit']."</td><td>".$r['time']."</td><td>".$r['classroom']."</td>";
        ...
        <button type="button" class="btn btn-warning col-md-12" id="btnAddCourse">新增課程</button><br><br>
    </div>
